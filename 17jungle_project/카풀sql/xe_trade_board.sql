...
CREATE TABLE `trade_board` (
  ...
  `trade_member_id` varchar(50) NOT NULL,
  `trade_content` mediumtext NOT NULL,
  `trade_time_posted` datetime NOT NULL,
  `trade_hit` int(11) NOT NULL DEFAULT '0',
...
INSERT INTO `trade_board` VALUES (1,'과연','test','될것인가악2222','2015-10-12 00:00:00',1),(2,'test','me','될것인가앙','2015-11-05 00:00:00',0),(3,'2345','ㅇㅅㅁㄷㅅ','추가','2015-11-07 19:54:16',0);
